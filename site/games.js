...
const games = [
  ...
  { label: "Zombs Royale", url: "../games/zombs.html" },
  ...
  { label: "Bee Swarm Simulator", url: "../games/bss/index.html" },
  { label: "Minecraft", url: "../games/mc.html" },
  ...
  { label: "Dino Game", url: "../games/dino.html" },
  { label: "Drift Boss", url: "https://driftboss.io/" },
  { label: "Baldi's Basics Classic Remastered", url: "../games/baldi/index.html" },
  ...
  { label: "Papa's Freezeria", url: "../games/ruffles/freeze.html" },
  ...
  { label: "Stickman Hook", url: "../games/Stickman-Hook/index.html" },
  ...
  { label: "Portal Remake", url: "../games/Portal.html" },
  { label: "Mario Kart", url: "../games/ruffles/mario-kart.html" },
  { label: "Pac-Man", url: "../games/ruffles/pacman.html" },
  { label: "Tetris", url: "../games/ruffles/tetris.html" },
  { label: "Block Blast", url: "../games/blockblast.html" },
  { label: "Learn to Fly", url: "../games/ruffles/learn-to-fly.html" },
  ...
  { label: "Mahjong", url: "../games/ruffles/mahjong.html" },
  ...
  { label: "Oneshot", url: "../Oneshot/index.html" },
  ...
  { label: "Eggfish", url: "../games/eggfish.html" },
  { label: "Moo Moo", url: "../games/moo.html" },
  { label: "Granny", url: "/granny/index.html" },
  { label: "Angry Birds 2", url: "/angry/index.html" },
  { label: "Run 3", url: "../games/run3.html" },
  { label: "Roblox", url: "../games/rblx.html" },
];
...
const siteLinks = [
  ...
  { label: "Settings", url: "../site/settings.html" },
];
